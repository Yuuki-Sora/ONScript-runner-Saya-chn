...
public class CrappyJavaNscripter extends JFrame {
    ...
    public class MyJPanel extends JPanel implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
        ...
        void saveGame() throws IOException {
            ...
            saver.close();
            JOptionPane.showMessageDialog(null, "Game saved successfully into \"save.s\". Don't remove this file. ");
        }
        ...
        void readGame() throws FileNotFoundException {
            ...
            //Stop current BGM
            if(bgm.stopped() == false)
                bgm.stop();

            //Stop character voice
            if(voice.stopped() == false)
                voice.stop();
            ...
            if(readG.hasNextLine()){
                ...
                sc = sc1;
                start_game = 0;
                CrappyJavaNscripter.this.repaint();
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if ((clicked == 1 && start_game == 1) || ctrled == 1) {
                ...
                if(read.contains("select ")){
                    ...
                    int s = JOptionPane.showOptionDialog(null, "Please choose one of the options. \nWhat you choose'll inevitably affect the storyline. \nThus, please carefully consider. ",
                            "Options available. ",
